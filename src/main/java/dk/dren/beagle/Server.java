...
import dk.dren.beagle.healthchecks.DiskSpaceCheck;
import dk.dren.beagle.injectors.InjectorBinder;
import dk.dren.beagle.resources.FrontPageResource;
...
public class Server extends Application<ServerConfiguration>{
	...
	public void run(ServerConfiguration configuration, Environment environment) throws Exception {
		// Register injectors.
		environment.jersey().register(new InjectorBinder(configuration, new BeagleDBI(configuration.getDatabase())));
